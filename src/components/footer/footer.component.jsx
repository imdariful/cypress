const Footer = () => {
  return (
    <div className='container'>
      <footer className='d-md-flex flex-sm-col flex-wrap justify-content-between align-items-center py-3 my-4 border-top'>
        <div className='col-md-4 d-flex justify-content-center align-items-center'>
          <span className='mb-md-0 text-muted'>© Md. Ariful Islam</span>
        </div>

        <div className='col-md-4 d-flex align-items-center justify-content-center'>
          <a
            href='https://github.com/arifulrony10/rick-and-morty-wiki'
            target='_blank'
        ...
        <ul className='nav col-md-4 justify-content-center list-unstyled d-flex'>
          ...
          <li className='ms-3'>
            <a className='text-muted' href='https://ariful.me' target='_blank'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                width='16'
                height='16'
